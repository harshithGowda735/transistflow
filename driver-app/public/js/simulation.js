class TripSimulator {
  ...
  interpolatePath(originalPath, stepDistanceFactor = 4) {
  ...
  async start(routeId) {
    ...
    this.path = this.interpolatePath(rawPath, 3);
    this.currentIndex = 0;
    this.isActive = true;
    ...
    this.timer = setInterval(() => {
      ...
      const realisticSpeed = 24 + Math.floor(Math.sin(this.currentIndex * 0.3) * 8);
